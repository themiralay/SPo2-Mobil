...
class _LoginRegisterState extends State<LoginRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    String emailValidator(String value) {
      ...
      if (value.isEmpty) return '*E-Posta Boş Geçilemez';
      if (!regex.hasMatch(value))
        return '*Lütfen Gerçek Bir E-Posta Adresi Giriniz.';
      else
        return null;
    }
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                                ...
                                child: CustomTextField(
                                  ...
                                  validator: (input) =>
                                  input.isEmpty ? "*Şifre Boş Bırakılamaz" : null,
                                  hint: "ŞİFRE",
                                )),
                            SizedBox(
                              height: 20,
                        ...
                        child: Column(children: <Widget>[
                          ...
                          Padding(
                              ...
                              child: CustomTextField(
                                ...
                                hint: "İSMİNİZ",
                                validator: (input) =>
                                input.isEmpty ? "*Boş Bırakılamaz" : null,
    ...
    return Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Padding(
              child: Container(
                child: filledButton("GİRİŞ YAP", primaryColor, Colors.white,
